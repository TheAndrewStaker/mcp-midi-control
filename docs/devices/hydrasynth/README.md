...
[`packages/hydrasynth/`](../../../packages/hydrasynth/).
...
- [`ICONIC-TONES.md`](../../_private/HYDRASYNTH-ICONIC-TONES.md):
  iconic-tones test portfolio used during tone-building development
  (founder-private; gitignored).
