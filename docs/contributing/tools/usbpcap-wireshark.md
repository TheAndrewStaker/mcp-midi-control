...
- **Virtual MIDI driver bridges** (loopMIDI, MIDI-OX routing through a
  ...
  `packages/fractal-midi/docs/devices/axe-fx-ii/community-re-methodology.md` for the full history.
...
- `packages/fractal-midi/docs/devices/axe-fx-ii/community-re-methodology.md`: full survey of capture
  techniques in the public Fractal RE corpus, including why this
  project chose USBPcap over virtual-MIDI-bridge approaches.
- `packages/fractal-midi/docs/capture-guides/juce-binarydata-extraction.md`: a complementary
