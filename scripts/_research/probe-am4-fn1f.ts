 ...
 *
 * The Axe-Fx II decode (Session 103, BK-070) confirmed that firing
 * fn 0x1F with a 2-byte septet-packed `effectId` payload causes the
...
async function main(): Promise<void> {
  ...
  md.push('  `packages/axe-fx-ii/src/descriptor/reader.ts:213`. Bump');
  md.push('  fractal-midi alpha; install in mcp-midi-tools; expose via the');
