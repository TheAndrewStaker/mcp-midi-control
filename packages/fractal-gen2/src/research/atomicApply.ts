...
import { resolveBlock, KNOWN_PARAMS, findParamFuzzy } from 'fractal-midi/gen2/axe-fx-ii';
...
// The PATCH_DUMP (fn 0x03) request comes from the canonical codec
// builder `buildPatchDumpRequest` ('fractal-midi/gen2/axe-fx-ii',
// hardware-verified MSB-first preset number + buffer-reload side
// effect documented there) — this research module used to hand-roll
// a byte-identical copy, which is exactly the silent-drift hazard the
// cross-package-regression rule warns about.
