...
golden: scripts/primitives-verify.ts#case-per-effect-paramtable-dispatcher (validates the same stride-16 descriptor tables against the mined dumps)
relates_to: []
consumed_in:
...
`scripts/primitives-verify.ts#case-per-effect-paramtable-dispatcher`
...
- 2026-05-22 (Rosetta-stone primitives audit): `verified_on` axis tags
