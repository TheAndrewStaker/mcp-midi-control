...
golden: scripts/primitives-verify.ts#case-septet-21bit-byte2-mask-preservation
...
`scripts/primitives-verify.ts#case-septet-21bit-byte2-mask-preservation`
runs two fixtures:
...
- Primitive entry created from synthesis pass 2026-05-22, promoting the
