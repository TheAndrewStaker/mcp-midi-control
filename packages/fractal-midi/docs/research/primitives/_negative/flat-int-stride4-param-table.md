...
golden: STUB (structural-only; negative finding, the positive stride-16 layout is exercised by scripts/primitives-verify.ts#case-per-effect-paramtable-dispatcher; see Symptoms / grep terms)
...
- 2026-05-22 (primitives backfill): negative finding registered after
