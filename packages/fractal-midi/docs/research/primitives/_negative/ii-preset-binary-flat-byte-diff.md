...
- 2026-05-22 (primitives backfill): negative finding registered.
  Citation correction: earlier CLAUDE.md text stated `fn 0x0E` for
  the atomic read primitive; the positive primitive entry confirms
  it is `fn=0x1F`. This primitive negative is the byte-correct
  reference.
