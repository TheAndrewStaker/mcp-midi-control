...
- Axe-Fx II's editor uses the static [[ii-axeedit-opcode-table]] (a
  ...
  workflow model is III + AM4 in the current primitives corpus.
...
pure-CPU algorithm, so no `primitives-verify` fixture applies. The
...
- 2026-05-22 (initial discovery): primitives-mine of
