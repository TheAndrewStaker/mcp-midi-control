...
This is the primitives' archetypal "naive port produces silent wire
...
- 2026-05-22 (Rosetta-stone primitives audit): promoted to
  primitive. This entry is the primitives' archetypal "naive port
...
- 2026-05-22 (primitives-mine of `ghidra-axe-edit-iii-store-preset.txt`):
  ...
  the primitive entry's structural decomposition wasn't. Goldens
