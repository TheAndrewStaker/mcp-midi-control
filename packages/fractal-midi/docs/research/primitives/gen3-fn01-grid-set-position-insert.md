...
golden: scripts/primitives-verify.ts#case-gen3-fn01-grid-set-position-insert
...
`scripts/primitives-verify.ts#case-gen3-fn01-grid-set-position-insert` builds
