...
class: bit-level
status: matched
discovered: 2026-05-22 (primitives-mine of ghidra-axe-edit-iii-store-preset.txt)
verified_on:
  - axe-edit-iii-binary
...
golden: scripts/primitives-verify.ts#case-iii-byte-stream-septet-pack-8to7
...
`scripts/primitives-verify.ts#case-iii-byte-stream-septet-pack-8to7`
...
- 2026-05-22 (primitives-mine of `ghidra-axe-edit-iii-store-preset.txt`,
  agent ba0vy28cl follow-up): primitive discovered as
  `FUN_14033f2d0` at L1278-1317. The primitive entry +
  `scripts/primitives-verify.ts` golden case shipped same-session per
  the primitives same-session discipline.
