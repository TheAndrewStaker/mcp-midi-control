...
discovered: 2026-05-22 (primitives-mine crosscheck of ghidra-axe-edit-iii-actions-and-shapes.txt)
verified_on:
  - axe-edit-iii-binary
...
- A captured wire trace from each of III, FM3, FM9 demonstrating
  ...
  the runtime side; primitives discipline prefers binary evidence
...
- 2026-05-22 (primitives-mine cross-check pass against
  ...
  primitive entry shipped per the discipline rule that newly
