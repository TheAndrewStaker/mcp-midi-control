...
/** Device-true FM9 display ranges, keyed by catalog family then paramId. 1891 rows. */
export const FM9_RANGES: Readonly<Record<string, Readonly<Record<number, Fm9ParamRange>>>> = {
  ...
  CHORUS: {
    0: { kind: 'enum', displayMin: 0, displayMax: 17, scale: 1, step: 0, typecode: 0x10, enumCount: 18 }, // CHORUS_TYPE
  ...
  /** sectionTag 13, wire stride 90 (fn=0x1F channel-block stride, ordinary records only). */
  DELAY: {
  ...
  DISTORT: {
    ...
    8: { kind: 'float', displayMin: 0, displayMax: 1, scale: 1, step: 0, typecode: 0x10 },
    9: { kind: 'float', displayMin: 0, displayMax: 1, scale: 1, step: 0, typecode: 0x10 },
    10: { kind: 'enum', displayMin: 0, displayMax: 330, scale: 1, step: 0, typecode: 0x10, enumCount: 331 }, // DISTORT_TYPE
    ...
    52: { kind: 'float', displayMin: 0.01, displayMax: 10, scale: 1, step: 0, typecode: 0x42 }, // DISTORT_XDRIVE
    ...
    56: { kind: 'float', displayMin: 0, displayMax: 10, scale: 2, step: 0.001, typecode: 0x32 }, // DISTORT_SPKRDRIVE
    ...
    74: { kind: 'enum', displayMin: 0, displayMax: 24, scale: 1, step: 0, typecode: 0x10, enumCount: 25 }, // DISTORT_TUBETYPE
    ...
    90: { kind: 'float', displayMin: -10, displayMax: 10, scale: 10, step: 0.002, typecode: 0x32 }, // DISTORT_DYNPRES
    91: { kind: 'float', displayMin: 0, displayMax: 10, scale: 10, step: 0.001, typecode: 0x32 }, // DISTORT_DYNDEPTH
  ...
  FUZZ: {
    0: { kind: 'enum', displayMin: 0, displayMax: 85, scale: 1, step: 0, typecode: 0x10, enumCount: 86 }, // FUZZ_TYPE
    ...
    32: { kind: 'enum', displayMin: 0, displayMax: 20, scale: 1, step: 0, typecode: 0x10, enumCount: 21 }, // FUZZ_PDTYPE
    33: { kind: 'float', displayMin: 1, displayMax: 4, scale: 1, step: 0, typecode: 0x10 }, // FUZZ_PDQTY
    34: { kind: 'enum', displayMin: 0, displayMax: 20, scale: 1, step: 0, typecode: 0x10, enumCount: 21 }, // FUZZ_NDTYPE
  ...
  INPUT: {
    ...
    3: { kind: 'float', displayMin: 1, displayMax: 100, scale: 1000, step: 0, typecode: 0x442 }, // INPUT_ATTACK
...
export const FM9_RANGE_SECTIONS: Readonly<Record<string, Fm9RangeFamilyMeta>> = {
  ...
  DELAY: { sectionTag: 13, stride: 90, recordCount: 90 },
