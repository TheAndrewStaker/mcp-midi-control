...
export const GEN3_READ_ROSTERS: Readonly<Record<string, Readonly<Record<number, string>>>> = {
  ...
  // drive block type selector (87 models, +28 FM9 cache, +1 III cache)
  FUZZ_TYPE: {
    0: "Rat Distortion",
    1: "PI Fuzz",
    2: "Tube Drive 3-Knob",
  ...
  // chorus block type selector (27 models, +10 III cache)
  CHORUS_TYPE: {
    0: "Digital Mono",
    1: "Digital Stereo",
    2: "Analog Mono",
  ...
  // flanger block type selector (31 models, +10 III cache)
  FLANGER_TYPE: {
    0: "Digital Mono",
    1: "Digital Stereo",
    2: "Analog Mono",
  ...
  // phaser block type selector (17 models, +3 III cache)
  PHASER_TYPE: {
    0: "Digital Mono",
    1: "Digital Stereo",
    2: "Script 45",
  ...
  // tremolo block type selector (7 models, +1 III cache)
  TREMOLO_TYPE: {
    0: "VCA Trem",
    1: "Panner",
    2: "Bias Trem",
  ...
  // filter block type selector (18 models, +8 III cache)
  FILTER_TYPE: {
    0: "Null",
    1: "Low-Pass",
    2: "Band-Pass",
